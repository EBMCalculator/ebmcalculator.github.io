...
<div class="hero-download-wrapper">
  <p class="hero-download-text">Available now on the App Store</p>
  <div class="hero-download-img">
    <a href="https://apps.apple.com/us/app/ebm-calculator/id6737999201" target="_blank" rel="noopener noreferrer">
      <img src="/assets/images/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg" alt="Download on the App Store">
    </a>
  </div>
</div>
